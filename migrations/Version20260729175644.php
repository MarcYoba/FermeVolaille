 ...
 */
final class Version20260729175644 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE batiments ADD bloc_id INT DEFAULT NULL');
        ...
        $this->addSql('CREATE INDEX IDX_124D79905582E9C0 ON batiments (bloc_id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE batiment (id INT AUTO_INCREMENT NOT NULL, PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_0900_ai_ci` ENGINE = MyISAM COMMENT = \'\' ');
        ...
        $this->addSql('DROP INDEX IDX_124D79905582E9C0 ON batiments');
        $this->addSql('ALTER TABLE batiments DROP bloc_id');
