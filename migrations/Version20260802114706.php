 ...
 */
final class Version20260802114706 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE suivi (id INT AUTO_INCREMENT NOT NULL, createt_at DATE NOT NULL, age INT NOT NULL, temperature DOUBLE PRECISION DEFAULT NULL, humidite DOUBLE PRECISION DEFAULT NULL, consommation_aliment DOUBLE PRECISION NOT NULL, consommation_eau DOUBLE PRECISION NOT NULL, nombre_morts INT NOT NULL, reformes INT NOT NULL, observations LONGTEXT DEFAULT NULL, effectif_initial INT NOT NULL, user_id INT DEFAULT NULL, bande_id INT DEFAULT NULL, INDEX IDX_2EBCCA8FA76ED395 (user_id), INDEX IDX_2EBCCA8F11999B4A (bande_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
