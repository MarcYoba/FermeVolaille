 ...
 */
final class Version20260729211331 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE magasin_dedier (id INT AUTO_INCREMENT NOT NULL, quantite DOUBLE PRECISION NOT NULL, createt_at DATE NOT NULL, batiment_id INT DEFAULT NULL, produit_id INT DEFAULT NULL, user_id INT DEFAULT NULL, INDEX IDX_9E5FC1DAD6F6891B (batiment_id), INDEX IDX_9E5FC1DAF347EFB (produit_id), INDEX IDX_9E5FC1DAA76ED395 (user_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP TABLE magasin_dedier');
