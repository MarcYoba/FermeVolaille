 ...
 */
final class Version20260727193409 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE magasin (id INT AUTO_INCREMENT NOT NULL, quantite DOUBLE PRECISION NOT NULL, createt_at DATE NOT NULL, produit_id INT DEFAULT NULL, user_id INT DEFAULT NULL, INDEX IDX_54AF5F27F347EFB (produit_id), INDEX IDX_54AF5F27A76ED395 (user_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
