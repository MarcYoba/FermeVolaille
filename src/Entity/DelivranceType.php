...
class DelivranceType extends AbstractType
{
    public function buildForm(FormBuilderInterface $builder, array $options): void
    {
        $builder
            ...
            // // 3. Coût Sanitaire
            // ->add('montantBrut', MoneyType::class, ['currency' => 'EUR', 'label' => 'Montant total brut'])
            // ->add('partAssurances', MoneyType::class, ['currency' => 'EUR', 'label' => 'Prise en charge Assurances/Mutuelle'])
            // ->add('partPatient', MoneyType::class, ['currency' => 'EUR', 'label' => 'Reste à charge patient'])
